      ...
      <section className="py-16 md:py-24">
        <div className="container">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((value) => (
              <div key={value.title} className="flex flex-col items-center text-center p-6 rounded-lg border border-border bg-secondary shadow-lg hover:shadow-xl transition-shadow">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {teamMembers.map((member) => (
              <div key={member.name} className="rounded-lg border border-border bg-background p-6 text-center shadow-xl hover:shadow-2xl transition-shadow">
                <Image
                  src={member.image}
                  alt={member.name}
                  width={150}
